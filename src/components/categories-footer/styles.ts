...
export const FooterWrapper = tw.div`w-full bg-white mt-8 mx-auto`;
...
export const Title = tw.h4`text-black text-base md:text-lg mb-1 md:mb-2`;

export const RouterLink = tw.a`text-gray-700 hover:text-black hover:underline text-sm md:text-base`;
